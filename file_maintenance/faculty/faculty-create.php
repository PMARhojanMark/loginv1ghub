                    ...
                    <div class="card-body">
                        <form action="faculty.php"
                         ...
                         enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label>IGROUP</label>
                                <input type="text" name="igroup" id="igroup" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>ITYPE</label>
                                <input type="text" name="itype" id="itype" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>RANKS</label>
                                <input type="text" name="ranks" id="ranks" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>BROFSERV</label>
                                <input type="text" name="brofserv" id="brofserv" class="form-control">
                            </div>
                            <div class="mb-3">
                                <label>STATUS</label>
